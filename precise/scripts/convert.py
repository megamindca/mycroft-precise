...
class ConvertScript(BaseScript):
    ...
    def convert(self, model_path: str, out_file: str):
        ...
        tf.io.write_graph(sess.graph.as_graph_def(), out_dir, filename + '.txt', as_text=True)
        ...
        cgraph = graph_util.convert_variables_to_constants(sess, sess.graph.as_graph_def(), [])
